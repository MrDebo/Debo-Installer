...
sleep 3
echo "[01] Lite DDos untuk website" | lolcat
...
echo "[31] Install InstaBot" | lolcat
echo "[32] Install Fish" | lolcat
echo "[33] Install ohmyzsh untuk styling termux" | lolcat
echo "[34] Bom call Tokopedia" | lolcat
echo "[35] Install SpammerGrab" | lolcat
echo "[36] Install Youtubedl" | lolcat
echo "[37] Chatting di termux" | lolcat
echo "[38] Install Breacher" | lolcat
echo "[39] Install Pagekite alternatif ngrok" | lolcat
echo "[40] Install ngrok" | lolcat
echo "[41] Install Hack Camera (VIP)" | lolcat
echo "[42] DDos Attack (VIP)" | lolcat
echo "[43] Tools Installing (VIP)" | lolcat
echo "[44] Hack CCTV (VIP)" | lolcat
echo "[45] Dark Facebook Premium (VIP)" | lolcat
echo "[46] Create Script Deface Keren" | lolcat
echo "[47] Deface Metode Webdav" | lolcat
echo "[48] Trojans" | lolcat
echo "[49] Buat Virtex" | lolcat
echo "[50] Cek Ip Saya" |lolcat
echo "[51] Hack Instagram" | lolcat
echo "[52] Hack WhatsApp" | lolcat
echo "[53] Deface Tebas Index" | lolcat
echo "[54] Install Spam Sms" | lolcat
echo "[55] Install Tools TUAN BADUT" | lolcat
echo "[56] Install Tools BAJINGAN V5" | lolcat
echo "[57] Install Tools BAJINGAN V6" | lolcat
echo "[58] Install Tools MR.CAKIL" | lolcat
echo "[59] Install SC Tool-X" | lolcat
echo "[60] Install Cloning Yahoo" | lolcat
echo "[61] Tembak Kuota Xl" | lolcat
echo "[62] Hack Lampu Listrik" | lolcat
echo "[63] 540 Dark Fly" | lolcat
echo "[64] Encrypt sc Python" | lolcat
echo "[65] Hack Facebook Target" | lolcat
echo "[66] Mencari Bug Website" | lolcat
echo "[00] Exit" | lolcat

echo "Silahkan Pilih Tools Yang Mau Anda Install" | lolcat

read -p "#MR.DEBO~>" pilihan
...
sleep 1
echo "Kalo Ada Yang Masih Belum Paham Bisa Hubungi ADMIN" | lolcat
sleep 1
echo "Contact Admin =>> 081539279932" | lolcat
sleep 1
exit
fi
