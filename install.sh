...
echo "[44] Hack CCTV (Work)" | lolcat
echo "[45] Dark Facebook Premium" | lolcat
...
toilet -f big -F gay "MR.DEBO" | lolcat
sleep 1
apt update
apt upgrade
pkg install git
...
cowsay -f eyes "Welcome To My Profile" | lolcattoilet -f big -F gay "MR.DEBO" | lolcat
sleep 1
apt update && apt upgrade
apt install git
apt install wget
